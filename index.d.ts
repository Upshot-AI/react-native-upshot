...
declare namespace Upshot {
    ...
    function dispatchEventsWithTimedEvents(timed: boolean, callback: (arg0: boolean) => any): void;
    ...
    function getRewardHistoryForProgram(programId: string, historyType: Int, successCallback: (arg0: string) => any, failureCallback: (arg0: string) => any): void;
    ...
    function setFontStyles(fontStyles: any): void;
