...
#ifndef UPSHOT_SWIFT_H
#define UPSHOT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Upshot",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Upshot26CustomActionViewController")
@interface CustomActionViewController : BKBaseViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6Upshot21CustomActionWireframe")
@interface CustomActionWireframe : NSObject
@property (nonatomic, strong) BKActivity * _Nullable activity;
@property (nonatomic, copy) NSString * _Nullable tag;
- (CustomActionViewController * _Nullable)make SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) JourneyManager * _Nonnull manager;)
+ (JourneyManager * _Nonnull)manager SWIFT_WARN_UNUSED_RESULT;
- (void)evaluateInboxWithArguments:(NSArray * _Nullable)arguments;
- (BKActivity * _Nullable)getActivityWithType:(NSInteger)type tag:(NSString * _Nonnull)tag SWIFT_WARN_UNUSED_RESULT;
- (void)sendResponseWithArguments:(NSArray * _Nullable)arguments;
- (void)userProfileWithArguments:(NSArray * _Nullable)arguments;
- (void)eventWithArguments:(id _Nonnull)arguments;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end



SWIFT_CLASS("_TtC6Upshot18MiniGameController")
@interface MiniGameController : BKBaseViewController
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
...
@interface MiniGameController (SWIFT_EXTENSION(Upshot)) <WKScriptMessageHandler>
...
@interface MiniGameController (SWIFT_EXTENSION(Upshot)) <WKNavigationDelegate>
...
+ (UIViewController * _Nullable)makeWithActivity:(BKActivity * _Nonnull)activity sessionId:(NSString * _Nonnull)sessionId appuid:(NSString * _Nonnull)appuid tag:(NSString * _Nullable)tag dismissBlock:(void (^ _Nonnull)(NSString * _Nullable))dismissBlock SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)getRewardsStatusWithAppuid:(NSString * _Nonnull)appuid completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSString * _Nullable))completionBlock;
- (void)getRewardsHistoryWithAppuid:(NSString * _Nonnull)appuid programId:(NSString * _Nonnull)programId type:(BKRewardHistoryType)type completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSString * _Nullable))completionBlock;
- (void)getRewardDetailsWithAppuid:(NSString * _Nonnull)appuid programId:(NSString * _Nonnull)programId completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSString * _Nullable))completionBlock;
- (void)sendRedeemValueWithAppuid:(NSString * _Nonnull)appuid transactionValue:(NSInteger)transactionValue redeemValue:(NSInteger)redeemValue programId:(NSString * _Nonnull)programId tag:(NSString * _Nonnull)tag completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSString * _Nullable))completionBlock;
@end


/// Responsible for handling all delegate callbacks for the underlying session.
SWIFT_CLASS("_TtC6Upshot15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(Upshot)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(Upshot)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC6Upshot18TriviaBarGraphView")
@interface TriviaBarGraphView : UIView
...
SWIFT_CLASS("_TtC6Upshot13TriviaPieView")
@interface TriviaPieView : UIView
@property (nonatomic) CGRect frame;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface TriviaPieView (SWIFT_EXTENSION(Upshot))
- (NSUInteger)numberOfSlicesInPieChart:(BKPieChart * _Null_unspecified)pieChart SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)pieChart:(BKPieChart * _Null_unspecified)pieChart valueForSliceAtIndex:(NSUInteger)index SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Null_unspecified)pieChart:(BKPieChart * _Null_unspecified)pieChart textForSliceAtIndex:(NSUInteger)index SWIFT_WARN_UNUSED_RESULT;
- (UIColor * _Null_unspecified)pieChart:(BKPieChart * _Null_unspecified)pieChart colorForSliceAtIndex:(NSUInteger)index SWIFT_WARN_UNUSED_RESULT;
@end


@interface TriviaPieView (SWIFT_EXTENSION(Upshot)) <BKPieChartDataSource, BKPieChartDelegate>
@end
...
@interface UIImage (SWIFT_EXTENSION(Upshot))
+ (UIImage * _Nullable)gifImageWithData:(NSData * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
+ (UIImage * _Nullable)gifImageWithURL:(NSURL * _Nullable)gifUrl SWIFT_WARN_UNUSED_RESULT;
+ (UIImage * _Nullable)imageFromGif:(NSURL * _Nullable)gifUrl SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC6Upshot12USTriviaView")
@interface USTriviaView : BKBaseViewController
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
@interface USTriviaView (SWIFT_EXTENSION(Upshot)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@interface USTriviaWireframe : NSObject
- (nullable instancetype)initWithActivity:(BKActivity * _Nullable)activity tag:(NSString * _Nullable)tag sessionId:(NSString * _Nullable)sessionId appuid:(NSString * _Nonnull)appuid OBJC_DESIGNATED_INITIALIZER;
- (USTriviaView * _Nullable)make SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
